function para = ZAC_nonrigid_2d(X,Y,opt_reg,opt_gm)
...
if opt_reg.display > 0
    ...
    hold off;
    axis off;
%     htext = text(-0.9,0.45,['Registration time = 0'],'fontsize',15);
    drawnow;
...
%     opt_gm.mass = nF;
    ...
    if opt_reg.display > 0
        ...
        hold off;
        axis off;
%         htext = text(-0.9,0.45,['Registration = ' num2str(reg_cnt)],'fontsize',15);
        drawnow;

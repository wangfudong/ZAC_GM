function  [P, C, W, iter, T] =prgls_GRBF_sparse(X, Y, beta, lambda, max_it, tol, viz, outliers, corresp,sigma2, t, nsc,verbose)
...
[BH1,mean_dist_1]=sc_compute_rota(X',t1',mean_dist_global,nbins_theta,...
...
%     iter
    ...
    [BH2,mean_dist_2]=sc_compute_rota(T',t2',mean_dist_1,nbins_theta,...
